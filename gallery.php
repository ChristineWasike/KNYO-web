	...
	<div id="slide" class="carousel-slide" data-ride="carousel">
		<div class="carousel-inner">
			<div class="carousel-item active img-fluid">
				<img src="images/15538561_764045700409320_95405087798591488_n.jpg" class="img-fluid carousel-img">
	...
	<div class="container-fluid">
		<div class="row site-section">
			<div class="col-12 text-center" data-aos="fade-up" data-aos-delay="">
				<h2 class="section-title">PHOTOS GALLERY</h2>
			</div>
		</div>
		<div class="row padding" id="orchestra-sections all">
			<?php 
			$selectphotos = $conn->query("SELECT * FROM gallery LIMIT 30");
			while ($fetchphotos = mysqli_fetch_array($selectphotos))
			{
				echo '
				<div class="col-lg-2 justify-content-center align-items-center">
					<img src="images/' .$fetchphotos['g_photo']. '" class="gallery-sec-image"><br><br>
				</div>'
				;
			}
			?>
		...
		<div class="row padding">
			<?php 
			$selectvideos = $conn->query("SELECT * FROM videos LIMIT 15");
			while ($fetchvideos = mysqli_fetch_array($selectvideos))
			{
				echo '
				<div class="col-lg-4 justify-content-center align-items-center">
					<video src="videos/' .$fetchvideos['g_video']. '" type="video/mp4" width="320" height="240" controls><br><br>
				</div>'
				;
			}
			?>
