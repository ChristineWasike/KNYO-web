	...
	<div id="slide" class="carousel-slide" data-ride="carousel">
		<div class="carousel-inner">
			<div class="carousel-item active img-fluid">
				<img src="images/13652049_525899124266115_1474866711_n.jpg" class="img-fluid carousel-img">
...
<section class="site-section" id="team-section">
	<div class="container-fluid">
		...
		<div class="row padding justify-content-center align-items-center">
			<?php 
			$selectmanagement = $conn->query("SELECT * FROM team WHERE t_category='management'");
			while ($fetchmanagement = mysqli_fetch_array($selectmanagement))
			{
				echo '
				<div class="col-sm-6 col-md-6 col-lg-2 justify-content-center align-items-center">
					<img src="images/' .$fetchmanagement['t_avator']. '" class="team-sec-image"><br><br>
					<span>' .$fetchmanagement['t_name']. '</span><br>
					<span>' .$fetchmanagement['t_portfolio']. '</span><br>
				</div>'
				;
			}
			?>
		...
		<div class="row padding offset-5">
			<div class="col-lg-12">
				<a href="orchestra.php" class="btn btn-primary">ORCHESTRA</a>
			</div>
		</div>
	</div>
</section>
