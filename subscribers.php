            ...
            <nav class="navbar navbar-expand-md fixed-top bg-dark" id="nav">
                <h1 class="mb-0 site-logo"><a href="index.php" class="h3 mb-0 top-text"><img src="images/clef.jpg" class="top-logo"> NYOKenya.</a></h1>
                    <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a href="admin-dash" class="nav-link active"><i class="fa fa-home fa-fw" aria-hidden="true"></i>Home</a>
                            </li>
                            <li class="nav-item">
...
<section class="side-navigation" id="side-navigation">
    <div class="container-fluid">
        ...
        <div id="main" class="">
            ...
            <p>Subscribers receive newsletters as soon as latest comes up. Below is a list of all subs to KNYO newsletters...</p>
                                ...
                                <div class="container">
                                  ...
                                  <table class="table table-dark table-striped">
                                    <tbody>
                                            ...
                                            <?php
                                                $selectquery = $conn->query("SELECT * FROM subscribers");
                                                
                                            
                                                while($fetchdata = mysqli_fetch_array($selectquery))
                                                {
                                                    echo 
                                                    '<tr><td>' .$fetchdata['sub_email']. '</td></tr>';
