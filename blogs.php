				...
				<h1 class="mb-0 site-logo"><a href="index.php" class="h3 mb-0 top-text"><img src="images/clef.jpg" class="top-logo"> NYOKenya.</a></h1>
					<div class="collapse navbar-collapse justify-content-center text-white" id="collapsibleNavbar">
						<ul class="navbar-nav">
							...
							<li class="nav-item">
								<a href="blogs.php" class="nav-link active"><i class="fa fa-rss fa-fw" aria-hidden="true"></i>Blogs</a>
							</li>
							<li class="nav-item">
	...
	<div id="slide" class="carousel-slide" data-ride="carousel">
		<div class="carousel-inner">
			<div class="carousel-item active img-fluid">
				<img src="images/1487819.jpg" class="img-fluid carousel-img">
...
<section class="site-section" id="blog-section">
	<div class="container-fluid">
		<div class="row padding offset-1">
			<?php
			$selectblogs = $conn->query("SELECT * FROM blogs");
			while ($fetchblogs = mysqli_fetch_array($selectblogs))
			{
				echo '
					<div class="col-sm-10 col-md-6 col-lg-4 padding">
						<div class="card justify-content-center align-items-center">
							<figure>
								<img src="images/'.$fetchblogs['b_avator'].'" class="img-fluid blogpage-image">
							</figure>
							<div class="card-text">
								<span>By '.$fetchblogs['b_author_name'].'</span>
							</div>
						</div>
					</div>
					<div class="col-lg-2"></div>
					<div class="col-sm-10 col-md-6 col-lg-6 blogdetails  padding">
						<span class="blogdate">Posted on '.$fetchblogs['b_date'].'</span><br><br>
						<span class="blogtitle">'.$fetchblogs['b_title'].'</span><br>
						<div class="blogmessage">
							<p>'.$fetchblogs['b_blog'].' </p>
						</div>
						<div class="likescomments">
							<span class="bloglikes"><a href="#"><i class="fa fa-thumbs-o-up"></i>0 Likes</a></span>
							<span class="blogcomments"><a href="#"><i class="fa fa-comments-o"></i>0 Comments</a></span>
						</div>
					</div>'
				;
			}
